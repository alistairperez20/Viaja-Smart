...
class AppNavigationScreen extends StatelessWidget {
  ...
  onTapIniciodelaApp(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.inicioDeLaAppScreen);
  }

  /// Navigates to the regStrateScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [Navigator] widget
  /// to push the named route for the regStrateScreen.
  onTapRegstrate(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.regStrateScreen);
  }
