...
class Descubre11Screen extends StatelessWidget {
                                                                  ...
                                                                  Align(
                                                                      ...
                                                                      child: Padding(
                                                                          ...
                                                                          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                            ...
                                                                            Container(
                                                                                margin: EdgeInsets.only(left: 8.h, top: 25.v),
                                                                            ...
                                                                            Container(
                                                                                ...
                                                                                child: Text("¡Descubre la historia!", maxLines: null, overflow: TextOverflow.ellipsis, style: theme.textTheme.bodySmall))
                                                                          ])))
                                                                ])),
                                                                      ...
                                                                      child: Padding(
                                                                          ...
                                                                          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                            Container(
                                                                                width: 197.h,
                                                                                decoration: AppDecoration.outlineBlack90001,
                                                                                child: Text("Sumergete en las arenas de Poneloya", maxLines: null, overflow: TextOverflow.ellipsis, style: theme.textTheme.titleMedium)),
                                                                            Container(
                                                                                width: 168.h,
                                                                                margin: EdgeInsets.only(left: 3.h, top: 22.v),
                                                                                decoration: AppDecoration.outlineWhiteA,
                                                                                child: Text("Las mejores playas", maxLines: null, overflow: TextOverflow.ellipsis, style: theme.textTheme.labelMedium))
                                                                          ])))
                                                                ])),
                                                                  ...
                                                                  Align(
                                                                      alignment:
                                                                          Alignment
                                                                              .topLeft,
                                                                      child: Padding(
                                                                          padding: EdgeInsets.only(left: 17.h, top: 20.v),
                                                                          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                            Container(
                                                                                width: 197.h,
                                                                                decoration: AppDecoration.outlineBlack90001,
                                                                                child: Text("Conoce la Casa de Rubén Darío", maxLines: null, overflow: TextOverflow.ellipsis, style: theme.textTheme.titleMedium)),
                                                                            SizedBox(height: 19.v),
                                                                            Container(
                                                                                width: 168.h,
                                                                                decoration: AppDecoration.outlineWhiteA,
                                                                                child: Text("La casa de un genio literario", maxLines: null, overflow: TextOverflow.ellipsis, style: theme.textTheme.labelMedium))
                                                                          ])))
                                                                ]))
                                                      ])),
                                              CustomImageView(
  ...
  onTapImgImagesixone(BuildContext context) {
